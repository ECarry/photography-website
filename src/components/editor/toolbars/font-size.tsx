...
export const FontSizeToolbar = () => {
    ...
    const isDisabled = !editor?.can().chain().focus().setFontSize("16px").run();
    ...
    return (
        <Popover>
            ...
            <PopoverContent align="start" className="w-40 p-1" onOpenAutoFocus={(e) => e.preventDefault()}>
                {FONT_SIZES.map(({ label, value }) => (
                    <button
                        ...
                        className={cn(
                            ...
                            currentFontSize === value && "bg-accent text-accent-foreground"
                        )}
                    >
